...
#python -u main_exp.py --dataset PTB --in_features 15 --n_classes 2 --seq_len 300 --dropout 0.2 --dropout_patch 0.0 --lr 5e-3 --weight_decay 0.001 --batch_size 128 --epochs 20 --cal_fraction 0.0
#python -u main_exp.py --dataset HAR --in_features 9 --n_classes 6 --seq_len 128 --dropout 0.2 --dropout_patch 0.0 --lr 5e-3 --weight_decay 0.001 --batch_size 128 --epochs 20 --cal_fraction 0.0
#python -u main_exp.py --dataset SHHS --in_features 1 --n_classes 5 --seq_len 3750 --dropout 0.2 --dropout_patch 0.0 --lr 5e-3 --weight_decay 0.001 --batch_size 32 --epochs 20 --cal_fraction 0.0
#python -u main_exp.py --dataset HAR --in_features 9 --n_classes 6 --seq_len 128 --dropout 0.2 --dropout_patch 0.1 --lr 5e-3 --weight_decay 0.001 --batch_size 128 --epochs 20 --cal_fraction 0.0
